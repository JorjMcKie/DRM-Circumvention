...
The page image grabbing and paging through the book is done with pyautoit.
"""
...
# PyAutoGUI region parameter expects (left, top, width, height)
...
answer = getResponse("need test picture? y/n >")
if answer == "y":
